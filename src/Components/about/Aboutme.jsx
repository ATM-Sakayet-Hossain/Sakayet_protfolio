              ...
              <div className="text">
                ...
                <div className="mt-12 flex items-center gap-25">
                  ...
                  <div className="flex gap-3">
                    <Link
                      to="https://www.facebook.com/Md.Shakhawat.Bhuiyan.434"
                      target="_blank"
                    ...
                    <Link
                      to="https://www.linkedin.com/in/atm-sakayet-hossain-348a9123b/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <Link
                      to="https://github.com/ATM-Sakayet-Hossain"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <Link
                      to="https://www.instagram.com/mdshakhawatbhuiyan434/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <Link
                      to="https://www.youtube.com/@mdshakhawatbhuiyan3801"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
